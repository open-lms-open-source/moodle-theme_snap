...
$string['cachedef_course_users_assign_ungraded'] = 'Ukládání uživatelů, kteří mají funkci mod/assign:submit na daném kurzu, do mezipaměti.';
$string['cachedef_course_users_quiz_ungraded'] = 'Ukládání uživatelů, kteří nemají funkci mod/assign:submit na daném kurzu, do mezipaměti.';
...
$string['choosereadme'] = 'Uživatelsky přívětivý a interaktivní design Snap odstraňuje překážky online učení, což vám umožní vytvořit moderní, poutavé zkušenosti, které uživatelé v současnosti od webu očekávají. Jeho intuitivní rozvržení je optimalizováno pro online učení se zaměřením na věci, na kterých záleží – což jsou vaše vzdělávací aktivity a obsah.';
$string['close'] = 'Zavřít';
...
<p>Přidat můžete až tři obrázky spolu s titulkem každého snímku a nepovinným podtitulkem. Nejlépe fungují obrázky s rozměry 1200×600 pixelů.</p>';
...
$string['customcss'] = 'Vlastní šablona stylů CSS (vyřazená)';
$string['customscss'] = 'Vlastní šablona stylů SCSS';
$string['customcssdesc'] = 'Podpora Open LMS neřeší problémy s obsahem souvisejícím se šablonou stylů CSS. Toto pole je vyřazené a mělo by se používat pouze pro starší účely. Pro budoucí úpravy použijte pole „Vlastní šablona stylů CSS“.';
$string['customscssdesc'] = 'Podpora Open LMS neřeší problémy s obsahem souvisejícím se šablonou stylů CSS.';
...
$string['deletingsection'] = 'Odstraňování sekce „{$a}“';
...
$string['favorited'] = 'Do oblíbených přidáno {$a}';
...
$string['snapfeeds'] = 'Kanály Snap';
$string['personalmenufeatures'] = 'Prvky osobní nabídky';
$string['advancedfeedsenable'] = 'Povolit pokročilé zdroje';
$string['advancedfeedsenabledesc'] = 'Pokročilé kanály načítají určité položky, což umožňuje kratší dobu načítání a obnovuje obsah na vyžádání.';
$string['advancedfeedsperpage'] = 'Počet zobrazených položek pokročilých kanálů';
$string['advancedfeedsperpagedesc'] = 'Vyberte počet položek, které se v kanálu zobrazí. Uživatelé mohou další položky zobrazit výběrem možnosti <strong>Zobrazit více</strong>.';
$string['advancedfeedslifetime'] = 'Rozšířená životnost kanálů';
$string['advancedfeedslifetimedesc'] = 'Určete dobu, po kterou budou kanály po přihlášení uloženy ve vyrovnávací paměti prohlížeče. Když nastavíte hodnotu 0, kanály se do vyrovnávací paměti prohlížeče nebudou ukládat.';
$string['refreshdeadlines'] = 'Obnovení termínů pomocí naplánované úlohy.';
$string['refreshdeadlinesdesc'] = 'Po spuštění úlohy se data termínu obnoví, aby se zrychlilo načítání stránek.';
...
$string['xofyanswered'] = 'Odpovědělo {$a->completed} z {$a->participants}';
$string['xofyattempted'] = 'Pokus provedlo {$a->completed} z {$a->participants}';
$string['xofycontributed'] = 'Přispělo {$a->completed} z {$a->participants}';
$string['xofysubmitted'] = 'Odeslalo {$a->completed} z {$a->participants}';
$string['xungraded'] = 'Neznámkováno: {$a}';
...
<li>Tato třída se přidá do <code>těla</code> značky Html</li></ul>
...
$string['spotinvalidratio'] = 'Tato kombinace barev pozadí nevyhovuje
<a href="https://www.w3.org/TR/WCAG20-TECHS/G18.html" target="_blank">hodnotě minimálního poměru WCAG 2.0 – 4,5:1</a>.
Aktuální hodnota proti {$a->name}: {$a->value}.';
...
$string['advancedfeed_viewmore'] = 'Zobrazit více';
$string['advancedfeed_reload'] = 'Obnovit';
...
$string['refreshdeadlinestaskoff'] = 'Data k vyplnění nebyla vyhledána. V nastavení Kanály Snap zapněte nastavení „Obnovit termíny pomocí naplánované úlohy“, aby tato úloha umožnila vyplnit data termínů uložená v mezipaměti.';
...
$string['showcourseinformation'] = 'Zobrazit informace o kurzu';
$string['pageactivitywithnodescription'] = 'Pokud je pole Popis stránky prázdné a Obsah stránky obsahuje méně než 200 znaků, ikona rozšíření pro aktivitu stránky se na stránce kurzu nezobrazí, protože obsah stránky bude sloužit jako popis stránky.';
$string['toggleadmindrawer'] = 'Přepnout šuplík administrátora';
$string['toggleblockdrawer'] = 'Přepnout šuplík bloků';
$string['togglesnapfeedsdrawer'] = 'Přepnout šuplík kanálů Snap';
