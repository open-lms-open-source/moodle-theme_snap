...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Ajusta</h2><img class=img-polaroid src="n2018/pix/screenshot.jpg" />';
$string['close'] = 'Tanca';
...
$string['coursefootertoggle'] = 'Mostra el peu de pàgina del curs.';
...
$string['coursetools'] = 'Eines del curs';
$string['createsection'] = 'Crea una secció';
$string['current'] = 'Actual';
$string['customcss'] = 'Personalitza CSS';
$string['customcssdesc'] = 'Afegeix qualsevol CSS addicional per al vostre lloc.';
$string['deadlines'] = 'Dates límit';
$string['deadlinestoggle'] = 'Dates límit';
$string['deadlinestoggledesc'] = 'Les dates límit mostren totes les dates límit d\'activitats properes dels cursos a què us heu matriculat.';
...
$string['favicondesc'] = 'Pengeu la vostra icona de web en format .ico aquí. La icona de web es mostrarà juntament amb el títol de pàgina a la barra de pestanyes del navegador i als marcadors.';
$string['favorite'] = 'Preferit {$a}';
$string['favorited'] = 'Marcat com a preferit {$a}';
$string['featurespots'] = 'Espots de presentació de funcions i avantatges';
$string['featurespotsedit'] = 'Edita els espots de presentació de funcions';
$string['featurespotshelp'] = 'Els espots de presentació de funcions serveixen per destacar els avantatges del vostre lloc i els avantatges principals per als usuaris actuals o potencials.
Els espots de presentació de funcions són perfectes per descriure les funcions o els avantatges principals del vostre lloc de manera resumida,
i es mostrarà sota la imatge de capçalera de la pàgina principal del vostre lloc.<br>
Podeu afegir fins a 3 espots; només cal que afegiu el títol, contingut i una imatge opcional. Totes les imatges que utilitzeu no poden superar els 200px d’amplada i han de tenir la mateixa alçada.';
$string['featurespotsheading'] = 'Capçalera de presentació de funcions';
...
$string['feedbacktoggle'] = 'Comentaris recents';
$string['feedbacktoggledesc'] = 'Comentaris recents mostra tots els comentaris recents cap als aprenents i les trameses que han de qualificar als educadors.';
$string['footnote'] = 'Peu de pàgina del lloc';
$string['footnotedesc'] = 'Un peu de pàgina per al vostre lloc. Aquest és el millor lloc per posar enllaços d’ajuda, assistència i de qualsevol altre lloc que tingui la vostra organització que voleu coneguin que els aprenents o educadors, com ara la biblioteca o el correu electrònic.';
...
$string['forumpoststoggledesc'] = 'Els 10 apunts més recents al fòrum de tots els cursos al què esteu matriculat es mostraran al menú personal.';
...
$string['hidenavblock'] = 'Oculta el bloc de navegació de Moodle predeterminat';
$string['hidenavblockdesc'] = 'Amb Ajusta, us recomanem que oculteu el bloc de navegació de Moodle predeterminat. ';
$string['hiddencoursestoggle'] = 'Cursos ocults ({$a})';
...
$string['logo'] = 'Logotip';
$string['logodesc'] = 'Pengeu el vostre logotip personalitzat aquí. El logotip es mostrarà a la capçalera a tot el lloc.';
$string['menu'] = 'Els meus cursos';
$string['messageread'] = 'Missatge llegit';
$string['messages'] = 'Missatges';
$string['messagestoggle'] = 'Missatges';
$string['messagestoggledesc'] = 'Missatges mostra els missatges més recents d’altres usuaris de les darreres 12 setmanes.';
$string['more'] = 'Més';
...
$string['personalmenu'] = 'Funcions de menú personal';
...
$string['pld'] = 'PLD';
$string['pluginname'] = 'Newton 2018';
$string['poster'] = 'Imatge de portada';
$string['posterdesc'] = 'Una imatge gran de portada per a la pàgina principal del vostre lloc. La imatge ha d’excloure el text. És recomanable que feu servir imatges de 1280px d’amplada per 500px d’alçada (fins a 2000px d’amplada) Si optimitzeu la vostra imatge per a la web, la pàgina es carregarà més ràpidament.';
$string['poweredbyrunby'] = 'Creat {$a} amb <a href="http://moodlerooms.com/" target="_blank">Moodlerooms</a>, amb tecnologia de <a href="http://www.moodle.com/" target="_blank">Moodle</a>.';
...
$string['subtitle'] = 'Descripció del lloc';
$string['subtitle_desc'] = 'Una línia d\'etiquetes breu sobre el vostre lloc, d’uns 240 caràcters. La descripció del vostre lloc pot mostrar-se a la pàgina principal.';
$string['themecolor'] = 'Color de la marca';
$string['themecolordesc'] = 'El color primari del vostre lloc que s’utilitza al fons dels enllaços, botons i menús. Els colors brillants queden millor i proporcionen al vostre lloc un aspecte modern.';
$string['title'] = 'Títol';
