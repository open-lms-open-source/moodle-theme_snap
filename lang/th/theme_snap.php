...
$string['cachedef_course_users_assign_ungraded'] = 'การแคชผู้ใช้ที่มีความสามารถ mod/assign:submit ในรายวิชาที่กำหนด';
$string['cachedef_course_users_quiz_ungraded'] = 'การแคชผู้ใช้ที่ไม่มีความสามารถ moodle/grade:viewall ในรายวิชาที่กำหนด';
...
$string['category_color_palette_description'] = 'ดูค่าเลขฐานสิบหกที่สัมพันธ์กันสำหรับสีที่ต้องการ ตัวเลขนี้จะไม่
ส่งผลกระทบต่อการกำหนดค่าใดๆ ซึ่งเป็นเพียงตัวอย่างเพื่อช่วยเหลือผู้ใช้งานในการสร้างค่าการกำหนดค่า';
$string['changecoverimage'] = 'เปลี่ยนภาพหน้าปก';
$string['changefullname'] = 'เปลี่ยนชื่อเว็บไซต์';
$string['chapters'] = 'บท';
$string['choosereadme'] = 'การออกแบบที่ใช้งานง่ายและตอบสนองได้ดีของ Snap ช่วยขจัดอุปสรรคในการเรียนรู้ออนไลน์ ช่วยให้คุณสามารถสร้างประสบการณ์ที่ทันสมัยและน่าสนใจที่ผู้ใช้คาดหวังบนเว็บในปัจจุบัน เค้าโครงที่ใช้งานง่ายเหมาะสำหรับการเรียนรู้ออนไลน์ โดยมุ่งเน้นไปที่สิ่งที่สำคัญ นั่นคือกิจกรรมการเรียนรู้และเนื้อหาสำหรับคุณ';
$string['close'] = 'ปิด';
...
$string['courseformatnotification'] = 'รูปแบบของรายวิชาปัจจุบันที่คุณใช้ไม่ได้รับการรองรับอย่างเต็มรูปแบบโดยธีม Snap เพื่อประสบการณ์ที่ดีที่สุดของ Open LMS ขอแนะนำให้ใช้รูปแบบหัวข้อหรือรายสัปดาห์กับธีม Snap สามารถเปลี่ยนแปลงรูปแบบของรายวิชาได้ใน<a href="{$a}">การตั้งค่ารายวิชา</a>';
...
$string['covercarouseldescription'] = '<p>การแสดงสไลด์แบบหมุนเวียนเป็นชุดของแบนเนอร์หมุนหรือสไลด์โชว์ที่ปรากฏในหน้าแรกของเว็บไซต์ของคุณแทนที่จะเป็นภาพหน้าปก</p>
<p>เพิ่มภาพได้สูงสุด 3 ภาพ ชื่อสำหรับแต่ละสไลด์ และคำบรรยายเสริมที่ไม่บังคับ รูปภาพขนาด 1200 x 600 พิกเซลจะทำงานได้ดีที่สุด</p>';
...
$string['customcss'] = 'CSS ที่กำหนดเอง (เลิกใช้แล้ว)';
$string['customscss'] = 'SCSS ที่กำหนดเอง';
$string['customcssdesc'] = 'Open LMS Support ไม่ได้แก้ไขปัญหาสำหรับเนื้อหาที่เกี่ยวข้องกับ CSS ฟิลด์นี้ถูกเลิกใช้แล้วและควรใช้เพื่อวัตถุประสงค์ในการสานต่อระบบเดิมเท่านั้น โปรดใช้ฟิลด์ \'Custom SCSS\' สำหรับการปรับแต่งในอนาคต';
$string['customscssdesc'] = 'Open LMS Support ไม่ได้แก้ไขปัญหาสำหรับเนื้อหาที่เกี่ยวข้องกับ CSS';
...
$string['defaultintrosummary'] = 'ขอต้อนรับสู่รายวิชาใหม่ของคุณ {$a}
<br>เริ่มต้นด้วยการอธิบายว่ารายวิชาของคุณเกี่ยวข้องกับอะไรโดยการใช้ข้อความ รูปภาพ เสียง และวิดีโอ';
$string['defaultsectiontitle'] = 'ส่วนที่ไม่ได้ตั้งชื่อ';
$string['debugerrors'] = 'แก้ไขข้อผิดพลาด';
$string['deleteassetconfirm'] = 'ลบ {$a}';
$string['deletingasset'] = 'กำลังลบ {$a}';
$string['deletingassetname'] = 'กำลังลบ {$a->type} "{$a->name}"';
...
$string['error:categorycolorinvalidvalue'] = 'ID บันทึกหรือค่าสีสำหรับหมวดหมู่ "{$a}” ไม่ถูกต้อง';
$string['error:categorynotfound'] = 'ไม่พบบันทึกหมวดหมู่ที่ ID "{$a}”';
...
$string['favorite'] = '{$a} ที่ชื่นชอบ';
$string['favorited'] = '{$a}  ที่เลือกเป็นที่ชื่นชอบ';
...
<p>ขนาดรูปภาพที่แนะนำคือสี่เหลี่ยมจัตุรัสและมีขนาดไม่เกิน 200px คูณ 200px</p>';
...
$string['featuredcategorieshelp'] = 'ไฮไลต์หมวดหมู่ที่โดดเด่นได้มากถึง 8 รายการในหน้าแรกของเว็บไซต์ของคุณ พิมพ์ ID หมวดหมู่เพื่อตั้งค่าเป็นหมวดหมู่ที่โดดเด่น';
...
$string['jsontextdescription'] = 'พื้นที่ข้อความจะตรวจสอบยืนยัน JSON ที่ระบุ ดังนั้นจึงจะอนุญาตเฉพาะหมวดหมู่ที่มีอยู่เท่านั้น
เฉพาะค่าที่เป็นตัวเลข เช่น บันทึก ID (บันทึกหมวดหมู่) ที่ใช้ได้ และเฉพาะค่าเลขฐานสิบหกเท่านั้นที่ระบบจะยอมรับเป็นสี
ตัวอย่างมีดังนี้:<br>
{"1":"#FAAFFF",<br>
"45":"#AFF",<br>
"65":"#FFF228",<br>
...
$string['movingdropsectionhelp'] = 'วางส่วน "{$a->moving}” ก่อนส่วน "{$a->before}"';
$string['moving'] = 'กำลังย้าย "{$a}"';
$string['movingcount'] = 'กำลังย้าย {$a} วัตถุ';
$string['movefailed'] = 'การย้ายสำหรับ "{$a}” ล้มเหลว';
$string['move'] = 'ย้าย "{$a}"';
...
$string['snapfeeds'] = 'ฟีด Snap';
$string['personalmenufeatures'] = 'คุณสมบัติเมนูส่วนบุคคล';
$string['advancedfeedsenable'] = 'เปิดใช้งานการฟีดขั้นสูง';
$string['advancedfeedsenabledesc'] = 'ฟีดขั้นสูงจะโหลดรายการบางรายการซึ่งช่วยให้เวลาโหลดเร็วขึ้น และจะรีเฟรชเนื้อหาตามความต้องการ';
$string['advancedfeedsperpage'] = 'จำนวนแสดงรายการฟีดขั้นสูง';
$string['advancedfeedsperpagedesc'] = 'เลือกจำนวนรายการที่จะแสดงในฟีด ผู้ใช้งานสามารถเลือก <strong>ดูเพิ่มเติม</strong> เพื่อแสดงรายการเพิ่มเติมได้';
$string['advancedfeedslifetime'] = 'อายุของฟีดขั้นสูง';
$string['advancedfeedslifetimedesc'] = 'เลือกระยะเวลาที่จะแคชเก็บฟีดไว้ในเบราว์เซอร์หลังจากเข้าสู่ระบบ การตั้งค่าเป็น 0 จะไม่แคชเก็บฟีดไว้ในเบราว์เซอร์';
$string['refreshdeadlines'] = 'รีเฟรชเวลาครบกำหนดโดยใช้ภารกิจที่กำหนดเวลาไว้แล้ว';
$string['refreshdeadlinesdesc'] = 'เมื่อเปิดใช้งานภารกิจนี้ ข้อมูลเวลาครบกำหนดจะถูกรีเฟรชเพื่อให้เวลาการโหลดหน้าเร็วขึ้น';
$string['mycoursessnapfeedsheading'] = 'ฟีด Snap';
$string['mycoursessnapfeedsdesc'] = 'หมายเหตุ: <strong>ฟีดขั้นสูง</strong> จะพร้อมใช้งานเมื่อมีอย่างน้อยหนึ่งตัวเลือก ได้แก่ <strong>เวลาครบกำหนด</strong> <strong>ผลตอบรับและการให้เกรด</strong> <strong>ข้อความ</strong> หรือ <strong>โพสต์กระดานเสวนา</strong> ถูกเลือกไว้';
...
$string['poweredbyrunby'] = 'สร้างโดยใช้ <a href="https://{$a->subdomain}.openlms.net/" target="_blank" rel="noopener">Open LMS</a>
ผลิตภัณฑ์ที่ใช้งาน <a href="https://moodle.com/" target="_blank" rel="noopener">Moodle</a><br>
ลิขสิทธิ์ © {$a->year} Open LMS, สงวนลิขสิทธิ์ทั้งหทด';
...
$string['released'] = 'เผยแพร่เมื่อ: {$a}';
...
$string['xofyanswered'] = 'ตอบแล้ว {$a->completed} จาก {$a->participants}';
$string['xofyattempted'] = 'พยายามแล้ว {$a->completed} จาก {$a->participants}';
$string['xofycontributed'] = 'มีส่วนร่วมแล้ว {$a->completed} จาก {$a->participants}';
$string['xofysubmitted'] = 'ส่งแล้ว {$a->completed} จาก {$a->participants}';
$string['xungraded'] = '{$a} ยังไม่ได้ให้เกรด';
...
<ul><li>ค่าในฟิลด์ผู้ใช้งานจะถูกทำการ <em>Slugified</em> โดยเป็นการแปลงอักขระทั้งหมดเป็นตัวอักษรพิมพ์เล็กและคั่นด้วยเครื่องหมายขีดกลาง (-)</li>
<li>สตริง <code>snap-pbb-</code> จะถูกเพิ่มส่วนนำหน้า</li>
<li>ห้องเรียนนี้จะถูกเพิ่มลงในแท็ก HTML <code>body</code></li></ul>
ตัวอย่างเช่น ค่าในฟิลด์ผู้ใช้งาน <em>Blueberry Extravaganza</em> จะถูก Slugified เป็น <code>snap-pbb-blueberry-extravaganza</code><br /><br />
คุณสมบัตินี้จะใช้ร่วมกับ Custom CSS คุณจำเป็นต้องเพิ่มเครื่องมือเลือก CSS โดยใช้คลาสใหม่ๆ ในส่วน <a class="snap-settings-tab-link" href="#themesnapbranding">พื้นฐาน</a>';
...
$string['pbb_field_description'] = 'ค่าของฟิลด์นี้จะถูก Slugified และใช้เป็นชื่อคลาส CSS ที่นำหน้าด้วย <code>snap-pbb-</code>';
...
$string['invalidratio'] = 'การผสมผสานสีนี้ไม่สอดคล้องตาม
<a href="https://www.w3.org/TR/WCAG20-TECHS/G18.html" target="_blank">ค่าอัตราส่วนขั้นต่ำ WCAG 2.0 คือ 4.5:1</a> ค่า: ”{$a}"';
$string['imageinvalidratio'] = 'ภาพนี้อาจมีปัญหาเกี่ยวกับค่าความเปรียบต่าง เนื่องจากไม่ตรงตามค่าอัตราส่วนต่ำสุดของ WCAG 2.0 คือ 4.5:1 ค่าพิกเซลเฉลี่ย: "{$a}"';
$string['catinvalidratio'] = 'หมวดหมู่สีต่อไปนี้ไม่สอดคล้องตาม
<a href="https://www.w3.org/TR/WCAG20-TECHS/G18.html" target="_blank">ค่าอัตราส่วนขั้นต่ำของ WCAG 2.0 คือ 4.5:1</a> :
เทียบกับสีพื้นหลังของไซต์ (สีขาว): "{$a->white}" เทียบกับสีพื้นหลังของแถบนำทาง: "{$a->custombar}" เทียบกับสีพื้นหลังของปุ่มรายวิชาของฉัน:  "{$a->customnav}"';
$string['spotinvalidratio'] = 'สีพื้นหลังไม่สอดคล้องตาม
<a href="https://www.w3.org/TR/WCAG20-TECHS/G18.html" target="_blank">ค่าอัตราส่วนขั้นต่ำของ WCAG 2.0 คือ 4.5:1</a>
ค่าปัจจุบันเทียบกับ {$a->name}: {$a->value}';
$string['imageinvalidratiocategory'] = 'ภาพนี้อาจมีปัญหาเกี่ยวกับค่าความเปรียบต่างกับสีของธีม เนื่องจากไม่ตรงตามค่าอัตราส่วนต่ำสุดของ WCAG 2.0 คือ 4.5:1 ค่าพิกเซลเฉลี่ย: "{$a}"';
...
$string['advancedfeed_viewmore'] = 'ดูเพิ่มเติม';
$string['advancedfeed_reload'] = 'รีเฟรช';
...
$string['refreshdeadlinestaskoff'] = 'ไม่ได้ค้นหาข้อมูลเพื่อใส่ข้อมูล โปรดเปิดการตั้งค่า “รีเฟรชเวลาครบกำหนดโดยใช้งานที่ตั้งเวลาไว้” ในการตั้งค่าฟีด Snap เพื่ออนุญาตให้งานนี้ทำการใส่ข้อมูลที่แคชสำหรับเวลาครบกำหนด';
...
$string['student'] = 'ผู้เรียน';
$string['showcourseinformation'] = 'แสดงข้อมูลรายวิชา';
$string['pageactivitywithnodescription'] = 'หากคำอธิบายหน้าว่างเปล่าและเนื้อหาหน้ามีอักขระน้อยกว่า 200 ตัว ไอคอนขยายจะไม่ปรากฏสำหรับกิจกรรมของหน้าบนหน้ารายวิชา เนื่องจากเนื้อหาของหน้าจะทำหน้าที่เป็นคำอธิบายหน้า';
$string['toggleadmindrawer'] = 'สลับลิ้นชักผู้ดูแลระบบ';
$string['toggleblockdrawer'] = 'สลับลิ้นชักบล็อก';
$string['togglesnapfeedsdrawer'] = 'สลับลิ้นชักฟีด Snap';
