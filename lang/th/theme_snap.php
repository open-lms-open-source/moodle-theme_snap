...
$string['featurespotshelp'] = '<p>เพิ่มจุดสนใจได้สูงสุด 3 จุดบนหน้าแรกของไซต์ของคุณเพื่อไฮไลต์สิทธิประโยชน์หลักๆ ต่อทั้งผู้ใช้งานปัจจุบันและผู้ที่มีแนวโน้มเป็นผู้ใช้งานในอนาคต</p>
<p>คุณสามารถเพิ่มรูปภาพ ชื่อ และคำอธิบายเนื้อหาลงในแต่ละฟีเจอร์ หากต้องการดูฟีเจอร์ในหน้าแรก คุณต้องป้อนชื่อ ไม่บังคับส่วนรูปภาพและคำอธิบายเนื้อหา</p>
...
$string['xakatwitterdesc'] = 'URL ของบัญชีของคุณ';
