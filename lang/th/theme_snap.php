...
$string['category_color_palette_description'] = 'ดูค่าเลขฐานสิบหกที่สอดคล้องกันสำหรับสีที่กำหนด สิ่งนี้เคยชิน ส่งผลกระทบต่อการกำหนดค่าใดๆ มันเป็นเพียงตัวอย่างเพื่อช่วยให้ผู้ใช้งานสร้างค่าการกำหนดค่า';
...
$string['covercarouseldescription'] = '<p> ภาพสไลด์เป็นชุดแบนเนอร์หมุนหรือสไลด์โชว์ที่ปรากฏในหน้าแรกของเว็บไซต์ของคุณแทนที่จะเป็นภาพหน้าปก </p><p> เพิ่มภาพได้สูงสุด 3 ภาพชื่อเรื่องสำหรับแต่ละสไลด์และคำบรรยายเสริม รูปภาพขนาด 1200 x 600 พิกเซลทำงานได้ดีที่สุด </p>';
...
$string['featurespotshelp'] = '<p>เพิ่มจุดสนใจได้สูงสุด 3 จุดในหน้าแรกของไซต์ของคุณเพื่อเน้นประโยชน์หลักๆ ของผู้ใช้งานปัจจุบันและผู้มีโอกาสเป็นลูกค้า </p><p>เพิ่มชื่อเนื้อหาและรูปภาพที่เป็นตัวเลือกสำหรับแต่ละคุณสมบัติ รูปภาพควรจะเป็นสี่เหลี่ยมจัตุรัสและต้องไม่ใหญ่กว่า 200px คูณ 200px</p>';
...
$string['jsontextdescription'] = 'พื้นที่ข้อความตรวจสอบความถูกต้องของ JSON ที่กำหนดดังนั้นอนุญาตเฉพาะหมวดหมู่ที่มีอยู่เท่านั้น เฉพาะค่าตัวเลขในฐานะที่เป็น id (เรคคอร์ดหมวดหมู่) ที่ถูกต้องและยอมรับเฉพาะค่าเลขฐานสิบหกเป็นสี นี่คือตัวอย่าง: <br>{"1":"#FAAFFF",<br>"45":"#AFF",<br>"65":"#FFF228",<br>"12":"#CC0084",<br>"56":"#CC0087",<br>"89":"#CCF084"}';
...
$string['poweredbyrunby'] = 'สร้างด้วย <a href="https://www.blackboard.com/blackboard-open-lms" target="_blank"> LMS แบบเปิดกระดานดำ </a><a href="https://moodle.com/" target="_blank"> Moodle </a> - ผลิตภัณฑ์ตาม - <br>ลิขสิทธิ์ &#169; {$a} Blackboard Inc. สงวนลิขสิทธิ์';
...
$string['pbb_description'] = 'ด้วยการเปิดใช้งาน <strong>การสร้างแบรนด์ตามโปรไฟล์</strong> คุณจะสามารถปรับแต่งประสบการณ์การสร้างแบรนด์สำหรับกลุ่มผู้ใช้งานที่เฉพาะเจาะจงตามฟิลด์โปรไฟล์ผู้ใช้งานที่เลือก<ul><li>ค่าฟิลด์ผู้ใช้งานจะเป็น <em>ที่มี slugified</em>; การแปลงอักขระทั้งหมดเป็นตัวพิมพ์เล็กและแยกด้วยเส้นประ (-)</li><li>สตริง <code>snap-pbb-</code> จะได้รับการเติม</li><li>คลาสนี้จะถูกเพิ่มไว้ใน <code>เนื้อหา</code> แท็ก Html</li></ul>ตัวอย่างเช่นค่าฟิลด์ผู้ใช้งาน <em>Blueberry Extravaganza</em> จะถูก slugified ให้เป็น <code>snap-pbb-blueberry-extravaganza</code><br /><br />คุณลักษณะนี้ใช้ร่วมกับ <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/Snap#advanced-branding_OTP-3" target="_blank"> CSS ที่กำหนดเอง</a> คุณจะต้องเพิ่มตัวเลือก CSS โดยใช้คลาสใหม่ในส่วน <a class="snap-settings-tab-link" href="#themesnapbranding">พื้นฐาน</a>';
