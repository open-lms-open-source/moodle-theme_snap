...
$string['category_color_description'] = 'รายวิชาประเภทสี รายวิชาเด็กใช้การกำหนดค่าหมวดหมู่ผู้ปกครองที่ใกล้ที่สุด';
...
ส่งผลกระทบต่อการกำหนดค่าใดๆ มันเป็นเพียงตัวอย่างเพื่อช่วยให้ผู้ใช้งานสร้างค่าการกำหนดค่า';
$string['changecoverimage'] = 'เปลี่ยนภาพหน้าปก';
$string['changefullname'] = 'เปลี่ยนชื่อไซต์';
$string['chapters'] = 'บท';
...
$string['courseformatnotification'] = 'รูปแบบของรายวิชาปัจจุบันที่คุณใช้ไม่ได้รับการสนับสนุนโดยรูปแบบ Snap เพื่อประสบการณ์ที่ดีที่สุด Blackboard Open LMS แนะนำให้ใช้รูปแบบหัวข้อหรือรายสัปดาห์กับชุดรูปแบบ Snap รูปแบบของรายวิชาสามารถเปลี่ยนแปลงได้ใน <a href="{$a}"> การตั้งค่ารายวิชา </a>';
...
$string['customcssdesc'] = 'โปรดทราบว่าด้วยพลังอันยิ่งใหญ่จะมีความรับผิดชอบที่ยิ่งใหญ่ ปัญหาใดๆ ที่เกิดจากการเพิ่ม CSS ที่นี่เป็นความรับผิดชอบของคุณในการแก้ไข การสนับสนุน LMS ของ Blackboard Open ไม่แก้ไขปัญหาหรือให้ความช่วยเหลือเกี่ยวกับเนื้อหาที่เกี่ยวข้องกับ CSS';
...
$string['error:categorycolorinvalidjson'] = 'รูปแบบ JSON ไม่ถูกต้องสำหรับหมวดหมู่รายวิชา';
$string['error:categorycolorinvalidvalue'] = 'บันทึก id หรือค่าสีสำหรับหมวดหมู่ " {$a} "ไม่ถูกต้อง';
$string['error:categorynotfound'] = 'บันทึกหมวดหมู่พร้อมรหัส " {$a} "ไม่พบ';
...
$string['featurespotshelp'] = '<p>เพิ่มจุดสนใจได้สูงสุด 3 จุดในหน้าแรกของไซต์ของคุณเพื่อเน้นประโยชน์หลักๆ ของผู้ใช้งานปัจจุบันและผู้มีโอกาสเป็นลูกค้า </p>
...
$string['featuredcourseshelp'] = 'ไฮไลท์รายวิชาที่แนะนำมากถึง 8 รายการในหน้าแรกของไซต์ของคุณ พิมพ์ ID รายวิชาเพื่อนำเสนอรายวิชา';
...
$string['footnote'] = 'ส่วนท้ายของไซต์';
$string['footnotedesc'] = 'ส่วนท้ายของคุณจะปรากฏทั่วทั้งไซต์ นี่คือสถานที่ที่ดีที่สุดในการใส่ลิงค์เพื่อช่วยเหลือสนับสนุนและเว็บไซต์อื่นๆ ที่องค์กรของคุณมีซึ่งคุณต้องการแบ่งปันกับผู้เรียนและนักการศึกษา ตัวอย่างเช่นห้องสมุดหรืออีเมล';
...
$string['forumposts'] = 'โพสต์ลงในกระดานสนทนา';
$string['forumpoststoggle'] = 'โพสต์ลงในกระดานสนทนา';
$string['forumpoststoggledesc'] = 'แสดงผู้ใช้งานโพสต์กระดานสนทนาล่าสุด 10 รายการจากรายวิชา';
...
$string['headingfont_desc'] = 'แบบอักษรนี้ใช้ในส่วนหัว (องค์ประกอบ h1 - h6) ทั่วทั้งไซต์ของคุณ หากคุณรวม webfont ที่กำหนดเองอย่าลืมเพิ่มลงในแบบฟอร์ม moodle พิเศษ moodle';
$string['helpwithlogin'] = 'ช่วยในการเข้าสู่ระบบ';
$string['helpwithloginandguest'] = 'ช่วยเหลือเกี่ยวกับการเข้าสู่ระบบ / การเข้าถึงของแขก';
...
$string['jsontextdescription'] = 'พื้นที่ข้อความตรวจสอบความถูกต้องของ JSON ที่กำหนดดังนั้นอนุญาตเฉพาะหมวดหมู่ที่มีอยู่เท่านั้น
เฉพาะค่าตัวเลขในฐานะที่เป็น id (เรคคอร์ดหมวดหมู่) ที่ถูกต้องและยอมรับเฉพาะค่าเลขฐานสิบหกเป็นสี
นี่คือตัวอย่าง: <br>
{"1":"#FAAFFF",<br>
"45":"#AFF",<br>
"65":"#FFF228",<br>
...
$string['linkedindesc'] = 'URL ของ LinkedIn ในองค์กรของคุณ';
...
$string['logodesc'] = 'โลโก้ของคุณจะปรากฏในส่วนหัวทั่วทั้งไซต์..';
...
$string['personalmenuadvancedfeedsenable'] = 'เปิดใช้งานฟีดขั้นสูง (แบบทดลอง)';
...
$string['poweredbyrunby'] = 'สร้างด้วย <a href="https://www.blackboard.com/blackboard-open-lms" target="_blank" rel="noopener">Blackboard Open LMS</a> ผลิตภัณฑ์จาก <a href="https://moodle.com/" target="_blank" rel="noopener">Moodle</a><br>
...
$string['displaydescription'] = 'แสดงคำอธิบาย';
...
$string['subtitle_desc'] = 'อธิบายไซต์ของคุณสั้นๆ สำหรับผู้ใช้งาน';
$string['themecolor'] = 'สีของไซต์';
$string['themecolordesc'] = 'สีสดใสทำงานได้ดีที่สุดและจะทำให้ไซต์ของคุณมีความทันสมัย';
...
$string['gotocalendarsnap'] = 'ไปที่ไซต์ของปฏิทิน';
...
เมื่อเปรียบเทียบกับสีพื้นหลังของไซต์ (สีขาว): "{$a->white}" เมื่อเปรียบเทียบกับสีพื้นหลังของแถบนำทาง: "{$a->custombar}" เมื่อเปรียบเทียบกับสีพื้นหลังของปุ่มรายวิชาของฉัน: "{$a->customnav}"';
