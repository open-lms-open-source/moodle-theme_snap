...
$string['category_color_palette_description'] = 'Zie de corresponderende hexadecimale waarde voor de gegeven kleur. Dit heeft
geen invloed op configuraties. het is slechts een voorbeeld om gebruikers te helpen de configuratiewaarde te bouwen.';
...
<br>Begin met te beschrijven waar je cursus over gaat met tekst, afbeeldingen, audio en video.';
...
$string['featurespotshelp'] = '<p>Voeg maximaal 3 uitgelichte spots toe aan de voorpagina van je site om de belangrijkste voordelen voor huidige en potentiële gebruikers te benadrukken.</p>
<p>Voeg een titel, inhoud en een optionele afbeelding toe voor elke functie. Afbeeldingen moeten vierkant zijn en mogen niet groter zijn dan 200px bij 200px.</p>';
...
$string['jsontextdescription'] = 'Het tekstgebied valideert de opgegeven JSON, zodat alleen bestaande categorieën zijn toegestaan,
alleen numerieke waarden als id-records (categorierecords) geldig zijn en alleen hexadecimale waarden worden geaccepteerd als kleuren.
Hierna volgt een voorbeeld:<br>
{&quot;1&quot;:&quot;#FAAFFF&quot;,<br>
&quot;45&quot;:&quot;#AFF&quot;,<br>
&quot;65&quot;:&quot;#FFF228&quot;,<br>
&quot;12&quot;:&quot;#CC0084&quot;,<br>
...
$string['pbb_description'] = 'Door <strong>Profielgebaseerde opmaak</strong> in te schakelen, kun je de opmaak voor een specifieke groep gebruikers aanpassen op basis van het gekozen gebruikersprofielveld.
<ul><li>Van de waarde van het gebruikersveld is een <em>slug</em> gemaakt; alle karakters worden omgezet in kleine letters en gescheiden door een streepje (-)</li>
...
Bijvoorbeeld van de waarde van het gebruikersveld <em>Blueberry Extravaganza</em> wordt de volgende slug gemaakt: <code>snap-pbb-blueberry-extravaganza</code><br /><br />
Deze functie wordt gebruikt in combinatie met aangepaste CSS. Je moet CSS-selectors toevoegen met behulp van de nieuwe klassen in de sectie <a class="snap-settings-tab-link" href="#themesnapbranding">Basisinstellingen</a>.';
...
Tegen de achtergrondkleur van de site (wit): &apos;{$a->white}&apos;. Tegen de achtergrondkleur van de navigatiebalk: &quot;{$a->custombar}&quot;. Tegen de achtergrondkleur van de knop Mijn cursussen: &quot;{$a->customnav}&quot;';
