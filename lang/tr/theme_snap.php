...
$string['courseformatnotification'] = 'Şu anda kullandığınız kurs formatı Snap teması tarafından tam olarak desteklenmiyor. Open LMS, en iyi deneyim için Snap temasıyla birlikte Konular veya Haftalık kurs formatlarının kullanılmasını önerir. Kurs formatını <a href="{$a}">kurs ayarları</a> bölümünden değiştirebilirsiniz.';
...
<br>Metin, resim, ses ve video yoluyla kursunun ne hakkında olduğunu anlatarak işe başlayın.';
