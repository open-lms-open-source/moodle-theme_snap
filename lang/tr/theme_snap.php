...
$string['courseformatnotification'] = 'Şu anda kullandığınız kurs biçimi Snap teması tarafından tam olarak desteklenmiyor. Open LMS, en iyi deneyim için Snap temasıyla birlikte Konular veya Haftalık kurs biçimlerinin kullanılmasını önerir. Kurs biçimi, <a href="{$a}">kurs ayarları</a> bölümünden değiştirilebilir.';
...
$string['headingfont_desc'] = 'Bu yazı tipi (sans-serif) sitenizdeki başlıklarda (h1-h6 öğeleri) kullanılır. Özel bir web yazı tipi ekliyorsanız bunu moodle ekstra html formuna eklemeyi unutmayın. Diğer öğelerin yazı tiplerini değiştirmek isterseniz lütfen Özel CSS seçeneğini kullanın. Bunu nasıl yapacağınızla ilgili örnekler için lütfen <a href="https://help.openlms.net/en/administrator/manage-a-site/snap-font-family-with-custom-css/" target="_blank">documentation</a> adresine göz atın.';
...
$string['readmore'] = 'Daha fazla oku&nbsp;»';
