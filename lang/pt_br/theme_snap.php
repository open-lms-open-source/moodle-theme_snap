...
$string['cachedef_course_users_assign_ungraded'] = 'Armazenamento em cache de usuários que têm o recurso mod/assign:submit em um determinado curso';
$string['cachedef_course_users_quiz_ungraded'] = 'Armazenar em cache usuários que não têm a capacidade moodle/grade:viewall em um determinado curso';
...
$string['choosereadme'] = 'O design fácil de usar e responsivo do Snap elimina as barreiras da aprendizagem on-line, permitindo que você crie a experiência moderna e envolvente que os usuários esperam na Web hoje. Seu layout intuitivo é otimizado para aprendizagem on-line, concentrando-se nas coisas que importam: suas atividades de aprendizagem e conteúdo.';
$string['close'] = 'Fechar';
...
$string['customcss'] = 'CSS personalizado (descontinuada)';
$string['customscss'] = 'SCSS personalizado';
$string['customcssdesc'] = 'O Open LMS Support não soluciona problemas de conteúdo relacionado ao CSS. Este campo está descontinuado e deve ser usado apenas para fins de compatibilidade com versões anteriores.Use o campo "Custom SCSS" para personalizações futuras.';
$string['customscssdesc'] = 'O Open LMS Support não soluciona problemas de conteúdo relacionado ao CSS.';
...
$string['dropzonelabel'] = 'Solte os arquivos para anexar ou <span class="fake-link">adicionar</span>';
$string['due'] = 'Prazo {$a}';
...
$string['favorited'] = 'Favoritos {$a}';
$string['featurespots'] = 'Locais dos recursos';
$string['featurespotsedit'] = 'Editar locais dos recursos';
$string['featurespotshelp'] = '<p>Adicione até seis pontos de recursos à página inicial do seu site para destacar os principais benefícios para os usuários atuais e potenciais.</p>
...
$string['featuredcategorieshelp'] = 'Destaque até oito categorias na página inicial do seu site. Digite o ID da categoria para destacá-la.';
...
$string['gotoactivity'] = 'Ir para atividade {$a}';
...
$string['snapfeeds'] = 'Feeds do Snap';
$string['personalmenufeatures'] = 'Recursos do menu pessoal';
$string['advancedfeedsenable'] = 'Habilitar feeds avançados';
$string['advancedfeedsenabledesc'] = 'Os feeds avançados carregam alguns itens de menus pessoais, o que permite tempos de carregamento mais rápidos e atualiza o conteúdo sob demanda.';
$string['advancedfeedsperpage'] = 'Contagem de exibição de itens de feeds avançados';
$string['advancedfeedsperpagedesc'] = 'Escolha o número de itens a serem exibidos no feed. Os usuários podem selecionar <strong>Visualizar mais</strong> para exibir itens adicionais.';
$string['advancedfeedslifetime'] = 'Duração avançada dos feeds';
$string['advancedfeedslifetimedesc'] = 'Escolha a duração em que os feeds permanecerão em cache no navegador após fazer login. Configurar o valor como 0 não salvará os feeds em cache no navegador.';
$string['refreshdeadlines'] = 'Atualizar prazos de entrega usando a tarefa agendada.';
$string['refreshdeadlinesdesc'] = 'Quando a tarefa for realizada, os dados de prazo de entrega serão atualizados para tempos de carregamento de página mais rápidos.';
...
Esse recurso é usado em conjunto com o CSS personalizado, você precisará adicionar seletores CSS usando as novas classes na seção Noções <a class="snap-settings-tab-link" href="#themesnapbranding">básicas</a>.';
...
$string['spotinvalidratio'] = 'A cor de fundo não está em conformidade com o
<a href="https://www.w3.org/TR/WCAG20-TECHS/G18.html" target="_blank">Valor mínimo da razão WCAG 2.0 4.5:1</a>.
Valor atual em relação a {$a->name}: {$a->value}.';
...
$string['advancedfeed_viewmore'] = 'Ver mais';
$string['advancedfeed_reload'] = 'Atualizar';
...
$string['toleft'] = 'Vá para a esquerda';
...
$string['opens'] = 'Abre: {$a}';
$string['opened'] = 'Aberto: {$a}';
$string['year'] = 'Ano';
$string['homepage'] = 'Página inicial';
$string['allyears'] = 'Todos os anos';
$string['courselink'] = 'Ir para o curso';
$string['student'] = 'Aluno';
$string['showcourseinformation'] = 'Mostrar informações do curso';
$string['pageactivitywithnodescription'] = 'Se a Descrição da Página estiver vazia e o Conteúdo da Página contiver menos de 200 caracteres, o ícone de expansão não será exibido para a Atividade de Página na página do Curso, pois o Conteúdo da Página servirá como Descrição da Página.';
$string['toggleadmindrawer'] = 'Alternar gaveta de administração';
$string['toggleblockdrawer'] = 'Alternar gaveta de blocos';
$string['togglesnapfeedsdrawer'] = 'Alternar gaveta de feeds do Snap';
