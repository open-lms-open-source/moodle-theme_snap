...
$string['dropzonelabel'] = 'إفلات الملفات لإرفاقها، أو <span class="fake-link">استعراضها</span>';
$string['due'] = '{$a} مستحق';
$string['edit'] = 'تحرير "{$a}"';
...
$string['jsontextdescription'] = 'تقوم منطقة النص بالتحقق من JSON المحدد، لذلك يتم السماح فقط بالفئات الموجودة، وتكون القيم العددية كسجلات المعرف (سجلات الفئة) فقط صالحة ويتم قبول القيم الست عشرية فقط كألوان.
وفيما يلي أحد الأمثلة على ذلك:<br>
{"1":"#FAAFFF",<br>
...
$string['poweredbyrunby'] = 'تم الإنشاء بواسطة <a href="https://www.blackboard.com/blackboard-open-lms" target="_blank" rel="noopener">Open LMS</a>,
...
$string['pbb_description'] = 'من خلال تمكين <strong>العلامة التجارية المستندة إلى ملف التعريف</strong>, ستتمكن من تخصيص تجربة العلامة التجارية لمجموعة معينة من المستخدمين استنادًا إلى حقل ملف تعريف المستخدم الذي تم اختياره.
<ul><li>ستكون قيمة حقل المستخدم <em>slugified</em>; تحويل جميع الأحرف إلى أحرف صغيرة وفصلها بشرطة (-)</li>
<li>سيتم إلحاق السلسلة بـ <code>snap-pbb-</code> </li>
<li>ستتم إضافة هذه الفئة إلى <code>body</code> Html tag</li></ul>
...
يتم استخدام هذه الميزة بالتزامن مع <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/Snap#advanced-branding_OTP-3" target="_blank">CSS مخصصة</a>,
سيتعين عليك إضافة محددات CSS باستخدام الفئات الجديدة في قسم <a class="snap-settings-tab-link" href="#themesnapbranding">الأساسيات</a>.';
