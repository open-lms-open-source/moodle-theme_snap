...
$string['cachedef_course_users_assign_ungraded'] = 'تخزين مؤقت للمستخدمين الذين لديهم صلاحية mod/assign:submit في مقرر دراسي معيّن';
$string['cachedef_course_users_quiz_ungraded'] = 'تخزين مؤقت للمستخدمين الذين ليس لديهم صلاحية moodle/grade:viewall في مقرر دراسي معيّن';
...
$string['choosereadme'] = 'يوفّر قالب Snap تصميمًا متجاوبًا وسهل الاستخدام يزيل الحواجز أمام التعلّم عبر الإنترنت، ما يتيح لك إنشاء تجربة حديثة وجذابة يتوقعها المستخدمون اليوم على الويب. تخطيطه البديهي مُحسَّن للتعلّم عبر الإنترنت، مع التركيز على ما هو مهم: أنشطة التعلّم والمحتوى.';
$string['close'] = 'إغلاق';
...
$string['highlightedsection'] = 'بارز';
...
$string['logo'] = 'الشعار';
$string['logodesc'] = 'يُعرض شعارك في الرأس عبر الموقع بالكامل.';
...
$string['snapfeeds'] = 'الموجزات في Snap';
...
$string['unsupportedcoverimagetype'] = 'إن نوع صورة الغلاف ({$a}) غير مدعوم';
...
$string['advancedfeed_viewmore'] = 'عرض المزيد';
$string['advancedfeed_reload'] = 'تحديث';
...
$string['toleft'] = 'الانتقال إلى اليسار';
