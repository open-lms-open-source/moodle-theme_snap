...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>محاذاة</h2><img class=img-polaroid src="snap/pix/screenshot.jpg" />';
...
$string['coursefootertoggle'] = 'إظهار تذييل المقرر الدراسي';
...
$string['coursetools'] = 'أدوات المقرر الدراسي';
$string['createsection'] = 'إنشاء قسم';
$string['current'] = 'حالي';
$string['customcss'] = 'CSS مخصص';
$string['customcssdesc'] = 'إضافة أي ملف CSS إضافي لموقعك.';
$string['deadlines'] = 'المواعيد النهائية';
$string['deadlinestoggle'] = 'المواعيد النهائية';
$string['deadlinestoggledesc'] = '"المواعيد النهائية" تعرض أي مواعيد نهائية للأنشطة القادمة الموجودة في المقررات الدراسية التي أنت مسجل بها.';
...
$string['favicondesc'] = 'يرجى رفع أيقونة المفضلة الخاصة بك بتنسيق ‎.ico هنا. سيتم عرض أيقونة المفضلة إلى جانب عنوان الصفحة في شريط علامات التبويب بالمستعرض وفي الإشارات المرجعية.';
$string['favorite'] = 'المفضلة {$a}';
$string['favorited'] = 'مضاف إلى المفضلة {$a}';
$string['feedbackavailable'] = 'الملاحظات المتاحة';
$string['feedbacktoggle'] = 'الملاحظات الحديثة';
$string['feedbacktoggledesc'] = 'الملاحظات الحديثة تعرض أحدث الملاحظات للمتعلِّمين والتقديمات التي تحتاج التقدير للمعلِّمين.';
$string['footnote'] = 'تذييل الموقع';
$string['footnotedesc'] = 'تذييل لموقعك. ذلك هو أفضل مكان لوضع ارتباطات للمساعدة والدعم وأي مواقع أخرى تمتلكها مؤسستك وتريد من المتعلمين/المعلمين الوعي بها مثل المكتبة والبريد الإلكتروني وما إلى ذلك.';
...
$string['forumpoststoggledesc'] = 'سيتم في القائمة الشخصية عرض أحدث 10 مشاركات بالمنتديات من كل المقررات الدراسية المسجل بها المستخدم الحالي.';
...
$string['logo'] = 'الشعار';
$string['logodesc'] = 'يرجى رفع شعارك المخصص هنا. سيتم عرض الشعار في رأس الصفحة عبر الموقع بأكمله.';
...
$string['messagestoggledesc'] = '"الرسائل" تعرض أحدث الرسائل من المستخدمين الآخرين، منذ آخر 12 أسبوعًا.';
$string['more'] = 'المزيد';
...
$string['personalmenu'] = 'ميزات القائمة الشخصية';
...
$string['posterdesc'] = 'صورة كبيرة لصفحة موقعك الأمامية. يجب أن تتضمن الصورة نصًا. تعمل الصور ذات 1280 بيكسل عرض × 500 بيكسل ارتفاع أو أكبر (حتى 2000 بيكسل عرض) بشكل أفضل. سوف يؤدي تحسين الصورة الخاصة بك للويب إلى تسريع وقت تحميل الصفحة.';
$string['poweredbyrunby'] = 'مدمج مع {$a} من <a href="http://moodlerooms.com/" target="_blank">Moodlerooms</a>، مدعوم بواسطة  <a href="http://www.moodle.com/" target="_blank">Moodle</a>.';
...
$string['subtitle'] = 'وصف الموقع';
$string['subtitle_desc'] = 'سطر وسم مختصر حول موقعك، حوالي 240 حرفًا في الطول. سيتم عرض وصف موقعك في صفحة الموقع الأمامية.';
$string['themecolor'] = 'لون العلامة التجارية';
$string['themecolordesc'] = 'اللون الأساسي لموقعك والذي يتم استخدامه في الارتباطات والأزرار وخلفيات القوائم. علمًا بأن الألوان الساطعة تعمل بشكل أفضل وسوف تمنح موقعك مظهرًا حديثًا.';
