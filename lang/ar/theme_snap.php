...
$string['headingfont_desc'] = 'يُستخدم هذا الخط (sans-serif) في العناوين (عناصر العناوين من h1 إلى h6) عبر موقعك، وإذا كنت تستخدم خط ويب مخصصًا، فتذكّر أن تضيفه إلى تنسيق html الإضافي الخاص بـالوحدة. أما إذا أردت تعديل أنماط خطوط عناصر أخرى، فيرجى استخدام خيار CSS المخصص، وللاطلاع على أمثلة حول كيفية القيام بذلك تُرجى مراجعة <a href="https://help.openlms.net/en/administrator/manage-a-site/snap-font-family-with-custom-css/" target="_blank">documentation</a>.';
