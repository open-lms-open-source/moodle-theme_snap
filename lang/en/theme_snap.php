...
$string['resourcedisplayhelp'] = 'Select how attachments and links appear in your course. The Snap theme doesn\'t support images or videos in activity card views.';
...
$string['multimediacard'] = 'Images and videos won\'t display in activity card views in the Snap theme. Please select a different theme for your course or remove the media from this activity.';
