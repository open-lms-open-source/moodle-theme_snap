...
$string['covercarosel'] = 'Cover Carosel';
...
$string['favicondesc'] = 'Favicons are shown in the address bar of your web browser, users bookmark&#8217;s and mobile shortcuts.';
...
$string['feedbacktoggledesc'] = 'Feedback and grading shows recent feedback to learners and submissions which need grading to educators.';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Your logo will be displayed in the header across the entire site.';
...
$string['pmtoggle'] = 'Show personal menu on login';
$string['pmtoggledesc'] = 'Opens the personal menu immediately after login';
$string['pld'] = 'PLD';
...
$string['gradestoggle'] = 'Grades';
$string['gradestoggledesc'] = 'Show users their grade in course cards in the personal menu';
