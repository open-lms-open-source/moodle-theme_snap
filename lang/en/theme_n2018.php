...
$string['cachedef_generalstaticappcache'] = 'N2018 general static application level cache';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>N2018</h2><img class=img-polaroid src="n2018/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the N2018 theme. For the best experience Moodlerooms recommends using the Topics or Weekly course formats with the N2018 theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['hidenavblockdesc'] = "In N2018 we recommend hiding the default Moodle navigation block. ";
...
$string['poweredbyrunby'] = 'Built with <a href="http://moodlerooms.com/" target="_blank">Moodlerooms</a>, altered by CITE/NITAE²,
