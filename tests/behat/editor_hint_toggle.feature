@theme @theme_n2018
Feature: the editor hint toggle should be ignored by N2018 in Moodlerooms 2.9
  ...
  Background:
    Given the following config values are set as admin:
      | theme_n2018_disableeditorhints | true |
  ...
  @javascript
  Scenario: Create a URL resource in N2018 theme
