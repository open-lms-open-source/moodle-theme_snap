...
Feature: When the moodle theme is set to Snap, students see meta data against course activities.
  ...
  @javascript
  Scenario: Show due date to group members with group overrides
    Given the following "courses" exist:
      | fullname | shortname | category | groupmode | theme |
      | Course Override | COverride | 0 | 1 | |
    And the following "course enrolments" exist:
      | user | course | role |
      | teacher1 | COverride | editingteacher |
      | student1 | COverride | student |
      | student2 | COverride | student |
    And the following "activities" exist:
      ...
      | assign   | COverride     | assign4  | Test assignment4 | Test assignment 4 | 1                                   | 1                               | 1       | ##2 January 2000 08:00##    |##1 January 2000 08:00##|
    And the following "groups" exist:
      | name     | course | idnumber |
      | G1       | COverride     | GI1      |
      | G2       | COverride     | GI2      |
    And the following "group members" exist:
      ...
      | student2 | GI2   |
    And I log in as "admin"
    And I am on "Course Override" course homepage
    And I am on activity "assign" "Test assignment4" page
    And I click on "#admin-menu-trigger" "css_element"
    ...
    And I am on "Course Override" course homepage
    And I follow "Topic 1"
    Then I should see "Due 5 January 2000"
    And I log in as "admin"
    And I am on "Course Override" course homepage
    And I follow "Topic 1"
    ...
    Then I should see "0 of 2 Submitted"
    And I log out
    And I log in as "student1"
    And I am on "Course Override" course homepage
    And I follow "Topic 1"
