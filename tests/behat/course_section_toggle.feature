...
@theme @theme_n2018
Feature: When the moodle theme is set to N2018, teachers can toggle the visibility of course sections in read mode and
  edit mode.
  ...
  Scenario: In read mode, teacher hides section.
    ...
    And I click on "#section-2 .n2018-visibility.n2018-hide" "css_element"
    And I wait until "#section-2 .n2018-visibility.n2018-show" "css_element" exists
    ...
    Given I click on "#section-2 .n2018-visibility.n2018-show" "css_element"
    And I wait until "#section-2 .n2018-visibility.n2018-hide" "css_element" exists
  ...
  hide section.
    ...
    And I click on "#section-1 .n2018-visibility.n2018-hide" "css_element"
  ...
  Scenario: In read mode, student cannot hide section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 2"
    Then "#section-2 .n2018-visibility" "css_element" should not exist
