    ...
    switch ($section) {
        ...
        case FRONTPAGEENROLLEDCOURSELIST:
            ...
            if (!empty($mycourseshtml)) {
                echo html_writer::tag('a',
                    ...
                    ['href' => '#skipmycourses', 'class' => 'skip-block']
                );

                // Wrap frontpage course list in div container.
                echo html_writer::start_tag('div', ['id' => 'frontpage-course-list']);
                ...
                echo html_writer::tag('span', '', ['class' => 'skip-block-to', 'id' => 'skipmycourses']);
        ...
        case FRONTPAGEALLCOURSELIST:
            ...
            if (!empty($availablecourseshtml)) {
                echo html_writer::tag('a',
                    ...
                    ['href' => '#skipavailablecourses', 'class' => 'skip-block']
                );
                ...
                echo html_writer::tag('span', '', ['class' => 'skip-block-to', 'id' => 'skipavailablecourses']);
            }
        break;
        ...
        case FRONTPAGECATEGORYNAMES:
            echo html_writer::tag('a',
                ...
                ['href' => '#skipcategories', 'class' => 'skip-block']
            );

            // Wrap frontpage category names in div container.
            echo html_writer::start_tag('div', ['id' => 'frontpage-category-names']);
            ...
            echo html_writer::tag('span', '', ['class' => 'skip-block-to', 'id' => 'skipcategories']);
        break;

        case FRONTPAGECATEGORYCOMBO:
            echo html_writer::tag('a',
                get_string('skipa', 'access', core_text::strtolower(get_string('courses'))),
                ['href' => '#skipcourses', 'class' => 'skip-block']
            );

            // Wrap frontpage category combo in div container.
            echo html_writer::start_tag('div', ['id' => 'frontpage-category-combo']);
            ...
            echo html_writer::tag('span', '', ['class' => 'skip-block-to', 'id' => 'skipcourses']);
        break;
