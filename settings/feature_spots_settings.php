...
$heading = new \core\lang_string('featurespots', 'theme_snap');
...
$title = new \core\lang_string('featurespotsheading', 'theme_snap');
$description = '';
...
$title = new \core\lang_string('featureoneimage', 'theme_snap');
...
$title = new \core\lang_string('featureonetitle', 'theme_snap');
$description = '';
$setting = new admin_setting_configtext($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_two_title';
$title = new \core\lang_string('featuretwotitle', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_three_title';
$title = new \core\lang_string('featurethreetitle', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '');
$snapsettings->add($setting);
...
$title = new \core\lang_string('featureonetitlelink', 'theme_snap');
$description = new \core\lang_string('featuretitlelinkdesc', 'theme_snap');
...
$title = new \core\lang_string('featuretwotitlelink', 'theme_snap');
$description = new \core\lang_string('featuretitlelinkdesc', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '', $linkvalidation);
$snapsettings->add($setting);

$name = 'theme_snap/fs_three_title_link';
$title = new \core\lang_string('featurethreetitlelink', 'theme_snap');
$description = new \core\lang_string('featuretitlelinkdesc', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '', $linkvalidation);
$snapsettings->add($setting);
...
$title = new \core\lang_string('featureonetitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);

$name = 'theme_snap/fs_two_title_link_cb';
$title = new \core\lang_string('featuretwotitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);

$name = 'theme_snap/fs_three_title_link_cb';
$title = new \core\lang_string('featurethreetitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);
...
$description = '';
$title = new \core\lang_string('featureonetext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_two_text';
$title = new \core\lang_string('featuretwotext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_three_text';
$title = new \core\lang_string('featurethreetext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);
...
$title = new \core\lang_string('featurefivetitlelink', 'theme_snap');
$description = new \core\lang_string('featuretitlelinkdesc', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '', $linkvalidation);
$snapsettings->add($setting);

$name = 'theme_snap/fs_six_title_link';
$title = new \core\lang_string('featuresixtitlelink', 'theme_snap');
$description = new \core\lang_string('featuretitlelinkdesc', 'theme_snap');
$setting = new admin_setting_configtext($name, $title, $description, '', $linkvalidation);
$snapsettings->add($setting);

$name = 'theme_snap/fs_four_title_link_cb';
$title = new \core\lang_string('featurefourtitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);

$name = 'theme_snap/fs_five_title_link_cb';
$title = new \core\lang_string('featurefivetitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);

$name = 'theme_snap/fs_six_title_link_cb';
$title = new \core\lang_string('featuresixtitlecb', 'theme_snap');
$description = new \core\lang_string('featuretitlecbdesc', 'theme_snap');
$setting = new admin_setting_configcheckbox($name, $title, $description, 0);
$snapsettings->add($setting);
...
$description = '';
$title = new \core\lang_string('featurefourtext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_five_text';
$title = new \core\lang_string('featurefivetext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);

$name = 'theme_snap/fs_six_text';
$title = new \core\lang_string('featuresixtext', 'theme_snap');
$setting = new admin_setting_configtextarea($name, $title, $description, '');
$snapsettings->add($setting);
