...
/**
 * N2018 page requirements manager.
...
class n2018_page_requirements_manager extends \page_requirements_manager {
    /**
     ...
     * the n2018_page_requirements_manager.
     */
    public function copy_page_requirements() {
        ...
        foreach ($props as $prop) {
            ...
            $n2018manprop = new \ReflectionProperty($this, $pname);
            // If the property is private or protected  set accessible, after the copy reset to not accessible.
            $isprotected = $n2018manprop->isPrivate() || $n2018manprop->isProtected();
            if ($isprotected) {
                $n2018manprop->setAccessible(true);
            }
            $n2018manprop->setValue($this, $pval);
            $n2018manprop->setAccessible(!$isprotected);
        }
