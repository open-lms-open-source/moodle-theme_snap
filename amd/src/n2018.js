...
/**
 * Main n2018 initialising function.
 */
define(['jquery', 'core/log', 'theme_n2018/headroom', 'theme_n2018/util', 'theme_n2018/personal_menu',
        'theme_n2018/cover_image', 'theme_n2018/progressbar'],
    function($, log, Headroom, util, personalMenu, coverImage, ProgressBar) {

        'use strict';

        M.theme_n2018 = M.theme_n2018 || {};
        ...
        var movePHPErrorsToHeader = function() {
            ...
            if (msgs.length) {
                ...
                var errorcont = $('<div id="footer-error-cont"><h3>' +
                    M.util.get_string('debugerrors', 'theme_n2018') +
                    '</h3><hr></div>');
                ...
                var errorlink = $('<a class="footer-error-link btn btn-danger" href="#footer-error-cont">' +
                    M.util.get_string('problemsfound', 'theme_n2018') + ' <span class="badge">' + (msgs.length) + '</span></a>');
        ...
        var bodyClasses = function() {
            var extraclasses = [];
            if ($('#notice.n2018-continue-cancel').length) {
            ...
            $(window).on('popstate hashchange', function(e) {
                ...
                if (newHash !== lastHash) {
                    if (location.hash === '#primary-nav') {
                        ...
                        $('#page, #moodle-footer, #js-n2018-pm-trigger, #logo, .skiplinks').css('display', '');
                        if (onCoursePage()) {
        ...
        var recentUpdatesFix = function() {
            $('#n2018-course-footer-recent-activity .info').each(function() {
                $(this).appendTo($(this).prev());
            });
            $('#n2018-course-footer-recent-activity .head .name').each(function() {
        ...
        return {
             ...
             * @param {int} userId
             */
            n2018Init: function(courseConfig, pageHasCourseContent, siteMaxBytes, forcePassChange,
                               messageBadgeCountEnabled, userId, sitePolicyAcceptReqd) {

                // Set up.
                M.cfg.context = courseConfig.contextid;
                M.n2018Theme = {forcePassChange: forcePassChange};
                ...
                $(document).ready(function() {
                    ...
                    // Allow deeplinking to bs tabs on n2018 settings page.
                    if ($('#page-admin-setting-themesettingn2018').length) {
                    ...
                    if ($('body').hasClass('n2018-pm-open')) {
                        personalMenu.update();
                    }
                    ...
                    if ((on_mod_settings || on_course_settings || on_section_settings) && page_not_in_blacklist) {
                        ...
                        $('#mform1 > fieldset').not(vital).wrapAll('<div class="n2018-form-advanced col-md-4" />');

                        // Add expand all to advanced column.
                        $(".n2018-form-advanced").append($(".collapsible-actions"));
                        // Add collapsed to all fieldsets in advanced, except on course edit page.
                        if (!$('#page-course-edit').length) {
                            $(".n2018-form-advanced fieldset").addClass('collapsed');
                        }
                        ...
                        $(main_form).wrap('<div class="n2018-form-required col-md-8" />');
                        ...
                        $("#page-mod-resource-mod .n2018-form-advanced #id_modstandardelshdr .fcontainer").append(description);
                        $("#page-mod-resource-mod .n2018-form-advanced #id_modstandardelshdr .fcontainer").append(showdescription);
                        ...
                        $("#page-mod-assign-mod .n2018-form-advanced #id_modstandardelshdr .fcontainer").append(filemanager);
                        $("#page-mod-assign-mod .n2018-form-required .fcontainer").append(duedate);

                        // Move availablity at the top of advanced settings.
                        var availablity = $('#id_visible').closest('.form-group').addClass('n2018-form-visibility');
                        ...
                        $(label).text(M.util.get_string('visibility', 'theme_n2018') + ' ');
                        ...
                        $('.n2018-form-advanced').prepend(availablity);
                    ...
                    if (messageBadgeCountEnabled) {
                        require(
                            [
                                'theme_n2018/conversation_badge_count-lazy'
